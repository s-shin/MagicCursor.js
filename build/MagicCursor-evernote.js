...
(function() {
  MagicCursor.Options.add("evernote", {
    ...
    draw: function(ctx, points, head, tail) {
      var a, b, color, grad, i, lineWidth, n, p, path, radius, t1, t2, v, _i, _j, _len, _ref;
      radius = this.radius, lineWidth = this.lineWidth, color = this.color;
      if (tail.length > 0) {
        path = [];
